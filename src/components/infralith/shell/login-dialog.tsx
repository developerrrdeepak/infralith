...
import { User, UserPlus, Upload, ArrowRight, Sparkles, Eye, EyeOff, X, Loader2, Mail, ArrowLeft } from 'lucide-react';
...
export default function LoginDialog() {
  const { showLogin, setShowLogin, handleLogin, handleSignUp, loginView, setLoginView, signupFormState, setSignupFormState, clearSignupForm } = useAppContext();
  ...
  const [interestSuggestions] = useState<string[]>([]);
  const [isSuggesting] = useState(false);
