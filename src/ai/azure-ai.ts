...
const GeometricReconstructionSchema = z.object({
    meta: z.object({
        ...
        sheet_type: z.enum(["floor_plan", "mixed_sheet", "site_plan", "elevation_only", "unknown"]).optional().nullable(),
        sheet_confidence: confidenceScoreSchema.optional().nullable(),
        plan_region_count: z.number().int().nonnegative().optional().nullable(),
        plan_region_confidence: confidenceScoreSchema.optional().nullable(),
        manual_review_recommended: z.boolean().optional().nullable(),
        sheet_analysis_reasons: z.array(z.string()).optional().nullable(),
        plan_regions: z.array(z.object({
            label: z.string(),
            level: z.number().int(),
            left: z.number(),
            top: z.number(),
            width: z.number(),
            height: z.number(),
            confidence: confidenceScoreSchema.optional().nullable(),
            source: z.enum(["cluster", "band", "whole"]).optional().nullable(),
        })).optional().nullable(),
    }).strict(),
